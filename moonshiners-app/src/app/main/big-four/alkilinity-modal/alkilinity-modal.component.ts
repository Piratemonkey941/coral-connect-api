...
@Component({
  selector: 'app-alkilinity-modal',
  templateUrl: './alkilinity-modal.component.html',
  styleUrls: ['./alkilinity-modal.component.scss']
})
export class AlkilinityModalComponent implements OnInit {

...
@Component({
  selector: 'app-magnesium-modal',
  templateUrl: './magnesium-modal.component.html',
  styleUrls: ['./magnesium-modal.component.scss']
})
export class MagnesiumModalComponent implements OnInit {

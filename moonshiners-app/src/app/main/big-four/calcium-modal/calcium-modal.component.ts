...
@Component({
  selector: 'app-calcium-modal',
  templateUrl: './calcium-modal.component.html',
  styleUrls: ['./calcium-modal.component.scss']
})
export class CalciumModalComponent implements OnInit {
